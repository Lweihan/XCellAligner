...
from nnunetv2.training.loss.compound_losses import DC_and_CE_loss, DC_and_BCE_loss, DC_and_Focal_loss
...
class nnUNetTrainer(object):
    ...
    def initialize(self, mode):
        if not self.was_initialized:
            ...
            self.loss = self._build_loss(mode)
    ...
    def _build_loss(self, mode):
        ...
        elif mode == 'weakly_supervised':
            print('Trainer weakly supervised')
            # loss = Cell_InfoNceLoss()
    ...
    def run_training(self, mode: str = 'supervised'):
        self.on_train_start(mode)
